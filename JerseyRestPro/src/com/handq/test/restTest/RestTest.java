package com.handq.test.restTest;
 ...
 * 
 * @author handaquan
 *此类是为了测试后台使用spring的restTemplete工具来调用外埠提供的rest接口。
 *主要针对post、get、put、delete
 */
...
//get方式***********************************************************************************************************
//		//参数直接放在URL中
//		String message = restTemplate.getForObject("http://handq.com:8080/rest/users", String.class );
